...
--
-- Host: localhost
-- Generation Time: May 05, 2014 at 06:42 AM
...
ALTER TABLE `sm_do_exercise`
  ADD CONSTRAINT `sm_do_exercise_exercise_id_fk` FOREIGN KEY (`exercise_id`) REFERENCES `sm_exercises` (`excersise_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
